...
export const SVG = ({
  ...
  const propsCursor = {
    ...ui,
    className: classNames(isHoverEffect ? classes.cursor : "", classes[color]),
  };
  const propsElse = {
    ...ui,
    className: classNames(isHoverEffect ? classes[name] : "", classes[color]),
  };
  ...
  const icons: { [name: string]: JSX.Element } = {
    ...
    loading: <LoadingIcon {...propsCursor} />
  };
