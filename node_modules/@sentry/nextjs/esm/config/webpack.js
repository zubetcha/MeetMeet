...
export function getWebpackPluginOptions(buildContext, userPluginOptions) {
    ...
    var clientInclude = ((_b = userNextConfig.sentry) === null || _b === void 0 ? void 0 : _b.widenClientFileUpload) ? [{ paths: [distDir + "/static/chunks"], urlPrefix: urlPrefix + "/static/chunks" }]
    ...
    var defaultPluginOptions = dropUndefinedKeys({
        ...
        ignore: isServer || !((_c = userNextConfig.sentry) === null || _c === void 0 ? void 0 : _c.widenClientFileUpload)
            ? []
